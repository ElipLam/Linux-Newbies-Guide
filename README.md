...
Nếu fastfetch không được đóng gói cho bản phân phối của bạn hoặc phiên bản được đóng gói đã cũ, [linuxbrew](https://brew.sh/) là một giải pháp thay thế tốtis a good alternative: `brew install fastfetch`
