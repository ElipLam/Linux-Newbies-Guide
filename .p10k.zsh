# Generated by Powerlevel10k configuration wizard on 2022-08-26 at 13:39 +07.
...
() {
  ...
  typeset -g POWERLEVEL9K_DISK_USAGE_NORMAL_BACKGROUND=46
  typeset -g POWERLEVEL9K_DISK_USAGE_WARNING_FOREGROUND=0
  typeset -g POWERLEVEL9K_DISK_USAGE_WARNING_BACKGROUND=226
  typeset -g POWERLEVEL9K_DISK_USAGE_CRITICAL_FOREGROUND=0
  typeset -g POWERLEVEL9K_DISK_USAGE_CRITICAL_BACKGROUND=190
  ...
  typeset -g POWERLEVEL9K_LOAD_NORMAL_BACKGROUND=46
  # Load color when load is between 50% and 70%.
  typeset -g POWERLEVEL9K_LOAD_WARNING_FOREGROUND=0
  typeset -g POWERLEVEL9K_LOAD_WARNING_BACKGROUND=226
  # Load color when load is over 70%.
  typeset -g POWERLEVEL9K_LOAD_CRITICAL_FOREGROUND=0
  typeset -g POWERLEVEL9K_LOAD_CRITICAL_BACKGROUND=190
  # Custom icon.
  ...
  function prompt_my_cpu_temp() { 
    ...
    if (( cpu_temp < 50 )); then 
      p10k segment -s NORMAL -b 046 -t "${cpu_temp}"$'\uE339' -i $'\uE350' 
    elif (( cpu_temp >= 50 )); then 
      p10k segment -s WARM -b 226 -t "${cpu_temp}"$'\uE339' -i $'\uE350' 
    elif (( cpu_temp >= 70 )); then 
    p10k segment -s HOT -b 196 -t "${cpu_temp}"$'\uE339' -i $'\uF737' 
    fi 
  }
